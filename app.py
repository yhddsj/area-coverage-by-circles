...
# Поля для ввода
center_lat = st.text_input("Введите географическую широту центра (например, 33.0784)")
center_lon = st.text_input("Введите географическую долготу центра (например, 68.9728)")
